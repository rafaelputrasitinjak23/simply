...
console.log(color(figlet.textSync("Rafael", {
font: 'DOS Rebel',
...
✉️  Script Base - Store
✉️  Author : Rafael
✉️  Gmail : rafaeltinjak8@gmail.com
✉️  Instagram : Anonymous

${chalk.green.bold("Script Made By Rafael :D")}\n`));
...
if (anu.action == 'add') {
Rafael.sendMessage(anu.id, { image: { url: ppuser }, mentions: [num], caption: `Haii Kak *@${num.split("@")[0]}* Selamat Datang Di Group *${metadata.subject}* 👋

Terima Kasih Sudah Bergabung Di Group ${metadata.subject}
`})
} else if (anu.action == 'remove') {
Rafael.sendMessage(anu.id, { image: { url: ppuser }, mentions: [num], caption: `Selamat Tinggal *@${num.split("@")[0]}* Di Group *${metadata.subject}*`})
} else if (anu.action == 'promote') {
Rafael.sendMessage(anu.id, { image: { url: ppuser }, mentions: [num], caption: `@${num.split('@')[0]} Ciee Jadi Admin Di Group ${metadata.subject}\n\n${metadata.desc}`  })
} else if (anu.action == 'demote') {
Rafael.sendMessage(anu.id, { image: { url: ppuser }, mentions: [num], caption: `@${num.split('@')[0]} Ciee Di Hapus Jadi Admin Di Group ${metadata.subject}\n\n${metadata.desc}`})
  }
}
} catch (err) {
console.log(err)
